...
model_dict = dict(
            ...
            deecamp = backbone.deecamp)

def parse_args(script):
    parser = argparse.ArgumentParser(description= 'few-shot script %s' %(script))
    parser.add_argument('--dataset'     , default='deecamp',        help='CUB/miniImagenet/cross/omniglot/cross_char/deecamp')
    parser.add_argument('--model'       , default='deecamp',      help='model: Conv{4|6} / ResNet{10|18|34|50|101}/deecamp') # 50 and 101 are not used in the paper
